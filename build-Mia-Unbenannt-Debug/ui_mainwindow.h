...
public:
    ...
    QPushButton *Auto_Start_Button;
    QLineEdit *Auto_Stepmax;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget1->setGeometry(QRect(460, 400, 245, 54));
        ...
        Auto_Start_Button = new QPushButton(layoutWidget1);
        Auto_Start_Button->setObjectName(QStringLiteral("Auto_Start_Button"));

        horizontalLayout_2->addWidget(Auto_Start_Button);

        Auto_Stepmax = new QLineEdit(layoutWidget1);
        Auto_Stepmax->setObjectName(QStringLiteral("Auto_Stepmax"));

        horizontalLayout_2->addWidget(Auto_Stepmax);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_5->setText(QApplication::translate("MainWindow", "Auto Generate", 0));
        Auto_Start_Button->setText(QApplication::translate("MainWindow", "Auto Start", 0));
    } // retranslateUi
